...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference("Assignment.count") do
      post assignments_url, params: { assignment: { description: @assignment.description, resolved: @assignment.resolved } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { description: @assignment.description, resolved: @assignment.resolved } }
